...
process.egRegTreeMakerSim = cms.EDAnalyzer("EGRegTreeMaker",
				        ...
				        caloPartsTag = cms.InputTag("mix","MergedCaloTruth"),
...
#customize DeepSC (SuperClusterECALNoThres)
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.modelFiles = cms.vstring("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thres235fb/model_smallpadding.pb", "RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thres235fb/model_largepadding.pb")

process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.configFileClusterFeatures = cms.string("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thres235fb/scaler_config_cls_norm.txt")
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.configFileWindowFeatures = cms.string("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thres235fb/scaler_config_wind_norm.txt")
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.configFileHitsFeatures = cms.string("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thres235fb/config_hits_inputs.txt")

process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.nClusterFeatures = cms.uint32(17)
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.nWindowFeatures = cms.uint32(6)
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.maxNClusters = cms.vuint32(15,60)
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.maxNRechits = cms.vuint32(20,60)
