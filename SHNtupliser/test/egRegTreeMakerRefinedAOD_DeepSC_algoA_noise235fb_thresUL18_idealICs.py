...
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.modelFiles = cms.vstring("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thresUL18/model_smallpadding.pb", "RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thresUL18/model_largepadding.pb")

process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.configFileClusterFeatures = cms.string("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thresUL18/scaler_config_cls_norm.txt")
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.configFileWindowFeatures = cms.string("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thresUL18/scaler_config_wind_norm.txt")
process.particleFlowSuperClusterECALNoThres.deepSuperClusterConfig.configFileHitsFeatures = cms.string("RecoEcal/EgammaClusterProducers/data/RecoEcal-EgammaClusterProducers/DeepSCModels/models_pfthres/model_noise235fb_thresUL18/config_hits_inputs.txt")
